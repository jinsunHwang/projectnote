...
//        안드로이드 6.0부터 권한 처리 방식 변경
//        사용자의 안드로이드 버전 파악하는 코드
...
//        checkSelfPermission() 메소드로 필요한 권한 검사
//        승인 안되면 ArrayList인 listPermissionsNeeded에 추가
...
//        listPermissionsNeeded에 추가된 권한이 한개라도 있으면
//        requestPermissions() 메소드로 해당 권한을 사용자가 승인할 수 있도록 요청
...
//    @param grantResults 권한 결과
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        switch (requestCode){
            case PERMISSION_MULTI_CODE: checkPermissionResult(permissions,grantResults);
...
//        권한이 부여되어 있지 않다면
    ...
    private void showPermissionDialog(){
        ...
        dialog.setPositiveButton(R.string.setting,
